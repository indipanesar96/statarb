...
class RiskManager:
    ...
    def __init__(self, cointegrated_pairs, current_window):
        self.raw_pairs = cointegrated_pairs
    ...
    def run_risk_manager(self):
        pairs_cov, pairs_expected_return  = self.__cov_mu(self.raw_pairs)
    ...
    def __port_ts(self, pair):
        ...
        pair_ts = self.current_window.get_data(universe = Universes.SNP, tickers = [pair[0][0],pair[0][1]], features = SnpFeatures.LAST_PRICE)
